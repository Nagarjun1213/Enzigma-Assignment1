...
public class Edgecase2specialchar {
	public static void main(String args[]) throws InterruptedException {
        ...
        driver.findElement(By.xpath("(//input[@name=\"username\"])[2]")).sendKeys("pyrade@thetechnext.net");
		...
		String firstName = "Nagarjun@"; 
		String lastName = "Bhole123";    

		String namePattern = "^[a-zA-Z]+$";

		 if (!firstName.matches(namePattern) || !lastName.matches(namePattern)) {
		    System.out.println("Error: First Name or Last Name contains special characters or numbers.");
		} 
		else {
		    ...
		    try {
		        WebElement errorMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(), 'Invalid input')]")));
		        System.out.println("Validation message displayed: " + errorMsg.getText());
		    } catch (TimeoutException e) {
		        System.out.println("No error message detected for invalid input!");
		    }
		}		
